...
$('ul.sitemap li:last-child').each(function () {
  ...
  if ($this.children('ul').length === 0){
    // Add border-left in every UL where the last LI has not children
      $this.closest('ul').css("border-left", "1px solid gray").css("margin-top", "9px").css("margin-left", "24px");
  } else {
...
$('ul.sitemap li.hasSubmenu').each(function () {
  $this = $(this);
  //$this.prepend("<a href='#'><i class='fa fa-plus-circle'></i><i style='display:none;' class='fa fa-plus-circle'></i></a>");
  $this.children("a").not(":last").removeClass().addClass("toogle");
});
// Actions to expand and consense
$('ul.sitemap li.hasSubmenu a.toogle').click(function () {
  $this = $(this);
